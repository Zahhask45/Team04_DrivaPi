...
- 🔄 Transitioning from bare-metal main to ThreadX implementation
- 🔄 Working to establish reliable CAN communication

### Gaspar - OS & Development Environment
- 🔄 Working on STM32/Raspberry Pi communication on AGL side
- 🔄 Preparing CAN socket to receive speed sensor data from STM32
- ✅ Identified CAN message conversion error causing incorrect speeds
- ✅ Removed loopback from CAN read functionality

### Hugo - Hardware & Fabrication
- ✅ Added more content to CAN search documentation
- ✅ Added ThreadX app implementation details to documentation
- ✅ Supported Bernardo and Gaspar on STM32/Raspberry Pi AGL CAN communications
- ✅ Helped with speed data transmission implementation

### Melanie - GUI & Team Coordination
- ✅ Documented UProtocol evaluation conclusions
- ✅ Determined CAN is unsuitable for UProtocol implementation
- ✅ Analysis: CAN capacity limited to 8 bits per communication vs UProtocol ~40-byte size requirement
...
- ❌ Discovered pin conflict: PB8 and PB9 used for motors conflict with FDCAN pins
- 🔄 Need to reconfigure GPIO pins to resolve FDCAN conflict
...
<p>
    <img width="500" height="700" src="https://github.com/user-attachments/assets/9625d5c7-380a-4547-8a7a-0624713063cb)"/>
</p>
---
...
- 🔄 STM32 CAN communication debugging with ThreadX (Bernardo)
- 🔄 AGL CAN socket preparation (Gaspar)
- 🔄 Motor code GPIO reconfiguration (Miguel)
- 🔄 Alternative communication protocol research (Melanie)
